...
# 1.20 → 1.50 (طلب مستخدم: نقاط دخول أقوى — دخولات أقل لكن أوثق،
# والتعرض الكلي لفقاعات اللحاق أفتح). الحركات ≥1.5$ هي الأكثر استمرارية
# ويُخطّأ حد يدوي أعلى من "فقط ≥1.2".
MOMENTUM_MIN_USD = _env_float("STRAT_MOMENTUM_MIN", 1.50)
...
# MAX_LOSS_USD (3.0) بهامش. يجمع وقف السيرفر أولاً ثم يبقى الديناميكي خلفية.
